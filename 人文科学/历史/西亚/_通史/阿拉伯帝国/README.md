...
- **对象类型**：跨越西亚、北非、中亚和伊比利亚的帝国体系与文明共同体，不是现代民族国家。
- **规范职责**：本页集中维护正统哈里发、倭马亚、阿拔斯及帝国分裂后的共同主线；伊朗、埃及、两河、黎凡特和伊比利亚等目录只展开本地经历并回链。
- **存放理由**：政治起点与早期核心位于阿拉伯半岛、叙利亚和两河流域，因此规范入口放在西亚通史；扩张范围不能被理解为西亚的现代边界。
...
flowchart TD
    ...
    Regional --> Fragment["帝国分裂后的伊斯兰世界扩展"]
